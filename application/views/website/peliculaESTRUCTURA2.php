    ...
    <div class="container capitulo">
        <div class="row">
            <div class="col-md-8 no-padding videonegro">
                ...
                <div class="col-md-12 pelicula_datos" style="position:absolute;bottom:0px;">
                    <div class="row">
            ...
            <div class="col-md-4 no-padding row card-body">
                <div class="col-6 card-body">
                    <img src="<?=base_url().$pelicula->imagen;?>" class="img-fluid img-serie" />
                </div>

                <div class="cabecera-cap col-6 no-padding card-body pelicula_datos">
                    <h2 class="tit-anun">
                        <?=$pelicula->nombre;?>
                    </h2>
