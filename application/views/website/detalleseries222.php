<section id="detalle-serie">
   <div class="container detas">
      <div class="row">
         <div class="col-md-8">
            <div class="back-g" style="background-image: url('<?=base_url();?>plantilla/website/img/title.png'); ">
               <h2 class="titulo-de"><?=$serie->nombre;?></h2>
            </div>
            <div class="row">
               <div class="col-md-5">
         ...
         <div class="col-md-12">
            <div class="back-g" style="background-image: url('<?=base_url();?>plantilla/website/img/title.png'); ">
               <h3 class="titulo-de">Lista de Capitulos</h3>
            </div>
            <div class="back-g" style="background-image: url('<?=base_url();?>plantilla/website/img/title.png'); ">
               <h3 class="titulo-de">Comentarios de <?=$serie->nombre;?></h3>
            </div>
            <div class="row">
               <div class="col-md-4">	
                  <?php if($user->foto==''){ ?>
