   ...
   <table id="grid" class="table table-striped table-bordered" cellspacing="0" width="100%">
      ...
      <tbody>
         ...
         <tr>
            ...
            <td><?=$key->fecha_m;?></td>
            <td>
               <p data-placement="top" data-toggle="tooltip" title="Edit"><button class="btn btn-primary btn-xs" data-title="Edit" data-toggle="modal" data-target="#edit<?=$key->id;?>" ><i class="fa fa-eye" aria-hidden="true"></i></button></p>
            </td>
            <td>
