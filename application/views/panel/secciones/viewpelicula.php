...
<section class="content-header panel-body">
   ...
   <div class="tab-content">
      <div id="menu2" class="content container-fluid tab-pane fade">
         <form id="nuevaser">
            <div class="form-group col-md-12">
               <label>Nombre:</label>
               <input type="text" class="form-control" id="nombre" name="nombre" required="" placeholder="Nombre" value="<?=$pelicula->nombre;?>">
            </div>
            <div class="form-group col-md-4">
               <label>Estado:</label>
               <select  class="form-control" id="estado" name="estado" required="" >
                  <option value="Por estrenar" <?php if($pelicula->estado=='Por estrenar') echo 'selected';?>>Por estrenar</option>
                  <option value="En emisión" <?php if($pelicula->estado=='En emisión') echo 'selected';?>>En emisión</option>
                  <option value="Finalizada" <?php if($pelicula->estado=='Finalizada') echo 'selected';?>>Finalizada</option>
               </select>
            </div>
            <div class="form-group col-md-4">
               ...
               <select  class="form-control" id="categoria" name="categoria" required="">
                  ...
                  <option value="<?=$key->nombre;?>" <?php if($pelicula->estado==$key->nombre) echo 'selected';?>><?=$key->nombre;?></option>
                  <?php }  ?>   
               </select>
            </div>
            <div class="form-group col-md-4">
               ...
               <select  class="form-control" id="dias" name="dias" required="">
                  <option <?php if($pelicula->dias=='Sin precisar') echo 'selected';?>>Sin precisar</option>
                  <option <?php if($pelicula->dias=='Lunes') echo 'selected';?>>Lunes</option>
                  <option <?php if($pelicula->dias=='Martes') echo 'selected';?>>Martes</option>
                  <option <?php if($pelicula->dias=='Miércoles') echo 'selected';?>>Miércoles</option>
                  <option <?php if($pelicula->dias=='Jueves') echo 'selected';?>>Jueves</option>
                  <option <?php if($pelicula->dias=='Viernes') echo 'selected';?>>Viernes</option>
                  <option <?php if($pelicula->dias=='Sábado') echo 'selected';?>>Sábado</option>
                  <option <?php if($pelicula->dias=='Domingo') echo 'selected';?>>Domingo</option>
               </select>
            </div>
            <div class="form-group col-md-6">
               <label>Duración:</label>
               <input type="text" class="form-control" id="duracion" name="duracion" required="" placeholder="De 20 a 40min" value="<?=$pelicula->duracion;?>">
            </div>
            <div class="form-group col-md-6">
               <label>Fecha de estreno:</label>
               <input type="date" class="form-control" id="fecha" name="fecha" required="" value="<?=$pelicula->estreno;?>">
            </div>
            <div class="form-group col-md-12">
               <label>Sinopsis:</label>
               <textarea name="content" id="sinopsis" name="sinopsis" required="" value="<?=$pelicula->descripcion;?>">
            ...
            <div class="col-md-12">
               ...
               <div class="form-check-inline">
                  ...
                  <input type="checkbox" class="form-check-input" id='genero[]' name="genero[]" value="<?=$key->id;?>" <?php if($pelicula->estado==$key->nombre) echo 'checked';?>> <?=$key->nombre;?>
                  </label>
               </div>
               <?php }  ?>  
            </div>
      ...
      <div id="home" class="content container-fluid tab-pane fade row in active">
         ...
         <div class="col-md-6">
            <span style="font-size:1.9em;"><?=$pelicula->nombre;?></span> <span>(<?=$pelicula->estreno;?>)</span>
            <br>
         ...
         <div class="col-md-2">
            <img src="<?=base_url().$pelicula->imagen2;?>" class="img-responsive">
            <form id="peliculasimagens" onsubmit="realizaProcesoimgs();return false; ">
               <input type="file" name="imagen" id="imagen" class="form-control" required="">
               <input type="hidden" name="id" id="id" value="<?=$pelicula->id;?>" />
                        ...
                        <div id="delete<?=$key->id;?>" class="modal fade " role="dialog">
                           <div class="modal-dialog" style="margin-top:10vw;">
                              ...
                              <div class="modal-content">
                                 ...
                                 <div class="modal-footer">
                                    <a href="<?=base_url();?>temporada/eliminar_temporada/<?=$key->id;?>/<?=$pelicula->id;?>"><button type="button" class="btn btn-danger">Si</button></a>
